...
clust8 <- read_csv("~/spbRecommend/data_for_tests/clust10.csv")
clust_tot_c <- read_csv("~/spbRecommend/data_for_tests/clust_tot_c2.csv")
knn_data <- read_csv("~/spbRecommend/data_for_tests/knn_data2.csv")
knn_data <- dplyr::select(knn_data, -1)
...
knn_fit <- train(clust ~., data = main, method = "knn", tuneLength=7)
